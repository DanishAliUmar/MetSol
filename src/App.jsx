  ...
  const servicesData = [
    {
      ...
      showInNav: true,
      description: 'Innovative Web Solutions for a Seamless User Experience',
      ...
      images: ['/Images/Shopify Store/Shopify Store 5.png', '/Images/Shopify Store/Shopify Store.jpg', '/Images/Landing Page/Landing Page 6.png', '/Images/Web Devlopment/Web Devlopment.jpg'],
      checkpointsHeading: 'Web Development',
      checkpointsDesc: 'Optimized & Scalable Web Apps Built with Modern Tech',
      checkpoints: ['Responsive design', 'SEO optimization', 'Custom development'],
      videoUrl: ['/Video/Background.mp4'],
      videoHeading: 'Web Development',
      videoDesc: 'We craft stunning and high-performance websites.',
      videoDesc2: 'Our solutions are user-centric and optimized for growth..',
    },
    {
      id: 2,
      ...
      images: ['/Images/Branding/Branding 20.jpg', '/Images/Branding/Branding 7.png', '/Images/Landing Page/Landing Page.png', '/Images/Shopify Store/Shopify Store 4.png'],
    ...
    },
    {
      ...
      images: ['/Images/Social Media Design/Social Meida Design 1.png', '/Images/Social Media Design/Social Meida Design 7.png', '/Images/Social Media Design/Social Meida Design 6.jpg', '/Images/assets/Service-4.jpg'],
