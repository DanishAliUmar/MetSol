  ...
  const servicesData = [
    {
      ...
      showInNav: true,
      description: 'We build websites that people love. We make sure your website looks good on all kinds of phones and computers. We also make sure it`s easy to find on search engines.',
      ...
      ctaHeading: "Web Support Solution",
      ctadesc: "Our web support solutions ensure your site runs smoothly, delivering optimal performance and reliability.",
      ...
      checkpointsHeading: 'Effective Web Services',
      checkpointsDesc: 'Web development is like building a house online. It`s about making a website that looks good and works well.',
      checkpoints: ['Responsive design', 'SEO optimization', 'Custom development'],
      videoUrl: 'https://www.youtube.com/embed/y1UarPueBBM',
      videoHeading: 'Web Development Services',
      videoDesc: 'Learn how our web development solutions can transform your business.',
      videoDesc2: 'Our websites are crafted for optimal performance, security, and scalability.',
      videoDesc3: '',
    },
    {
      id: 2,
