...
const Footer = () => {
  return (
    <footer className="w-full bg-[#000] landing__on__scroll ">
      <main className="max-w-[1200px] mx-auto ">
        <div className="py-[42px] px-[15px] sm:px-[20px] ">
          <div className="flex items-center justify-between "><img className="h-[50px] cursor-pointer "
            src="/Images/Logo/met sole logo-01.png"
            alt=""/>
            <div className="sm:block hidden ">
              <div className="flex items-center gap-[6px] ">
                ...
                <div className="flex flex-col items-center gap-[9px] mt-[4px] ">
                  <div className="flex items-center gap-[2px] "><svg className=" cursor-pointer " width="12"
                    height="12" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="#FF3D2E"></path>
                  </svg><svg className=" cursor-pointer " width="12" height="12" viewBox="0 0 16 15"
          ...
          <div className="bg-[#141414] relative rounded-[14px] p-[18px] sm:p-[30px] lg:p-[42px] flex items-center gap-[30px] lg:gap-[58px] mt-[32px] flex-col md:flex-row ">
            <p className="absolute top-[10px] text-[13px] text-red-600 errorPeragraph "></p>
            <div className="flex-1">
              <div className="flex flex-1 w-full rounded-[8px] overflow-hidden flex-col sm:flex-row gap-[7px] sm:gap-[0px] ">
                <input className="px-[12px] py-[12px] outline-none border-[0px] text-[14px] text-[#001436] flex-1 rounded-[8px] sm:rounded-[0px] " type="email" name="" id="subscribeEmail" placeholder="Email Address" required=""/>
                  <div className="bg-[#f8955b] flex items-center justify-center px-[28px] cursor-pointer uppercase select-none text-[15px] h-[48px] text-[#fff] font-[500] rounded-[8px] sm:rounded-[0px] " onclick="subscribeEmail()" >Subscribe</div>
              </div>
            </div>
            <div className="flex-1 w-full flex items-center gap-[26px] justify-center md:justify-end flex-wrap  ">
              ...
              <div className="flex items-center gap-[24px] ">
                <div className="flex items-center gap-[8px] "><span
                  className="flex items-center justify-center h-[32px] w-[32px] "><svg
                    className="h-full w-full " viewBox="0 0 28 28" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center gap-[8px] "><span
                  className="flex items-center justify-center h-[32px] w-[32px] "><svg width="35"
                    height="34" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center gap-[8px] "><span
                  className="flex items-center justify-center h-[32px] w-[32px] "><svg
                    className="h-full w-full " viewBox="0 0 34 34" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex-[3] w-full">
                ...
                <div className="flex pt-[22px] flex-wrap gap-[30px] ">
                  <div className="flex-1 w-full ">
                    <p className="text-[13px] text-[#ffffffcd] mt-[7px] cursor-pointer whitespace-nowrap ">
              ...
              <div className="flex-1">
                ...
                <div className="pt-[22px] ">
                  ...
                  <p className="text-[13px] text-[#ffffffcd] mt-[7px] cursor-pointer whitespace-nowrap ">
                    Rise</p>
                  <p
                    className="border-b border-[#fff] text-[13px] text-[#fff] mt-[7px] cursor-pointer max-w-max ">
                    View All</p>
                </div>
              </div>
            </div>
        ...
        <div className="pt-[22px] sm:pt-[32px] pb-[32px] flex justify-between px-[12px] flex-col-reverse sm:flex-row ">
          <div className="mt-[22px] sm:mt-[0px] display_flex ">
            <div className="flex items-center gap-[12px] sm:gap-[20px] flex-wrap justify-center ">
              <div className="flex items-center gap-[9px] "><svg width="20" height="20" viewBox="0 0 20 20"
                fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  fill="white"></path>
                <mask id="mask0_649_703" maskUnits="userSpaceOnUse" x="7" y="3" width="10" height="18">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M13.6348 20.728V12.7667H16.3582L16.7668 9.66317H13.6348V7.68199C13.6348 6.78372 13.8881 6.17156 15.2029 6.17156L16.877 6.17088V3.39495C16.5875 3.35804 15.5937 3.27344 14.437 3.27344C12.0216 3.27344 10.368 4.71952 10.368 7.37462V9.66317H7.63636V12.7667H10.368V20.728H13.6348Z"
                    fill="white"></path>
                </mask>
                ...
                className="flex items-center justify-center h-[30px] w-[30px] cursor-pointer "><svg width="24"
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="white"></path>
                  <mask id="mask0_620_706" maskUnits="userSpaceOnUse" x="3" y="4" width="19" height="16">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M21.8182 6.14561C21.1356 6.44807 20.4032 6.65319 19.6337 6.74477C20.4194 6.27425 21.0208 5.52795 21.3059 4.6414C20.5689 5.07713 19.7553 5.39352 18.8885 5.56504C18.1943 4.82452 17.207 4.36328 16.1118 4.36328C14.0108 4.36328 12.3072 6.06683 12.3072 8.16671C12.3072 8.46452 12.3408 8.7554 12.4058 9.03355C9.24436 8.87477 6.44106 7.36013 4.56485 5.05858C4.23688 5.61949 4.0503 6.27307 4.0503 6.97074C4.0503 8.29071 4.72246 9.45537 5.74227 10.1368C5.11879 10.1159 4.53239 9.9444 4.01903 9.65931V9.70683C4.01903 11.5494 5.33088 13.0873 7.07033 13.4373C6.75164 13.523 6.41558 13.5705 6.06791 13.5705C5.82224 13.5705 5.58467 13.5462 5.35173 13.4998C5.83612 15.0122 7.2407 16.1119 8.90485 16.1421C7.60343 17.1619 5.96246 17.768 4.18012 17.768C3.87303 17.768 3.57055 17.7494 3.27273 17.7158C4.95658 18.7971 6.95564 19.4275 9.10418 19.4275C16.1026 19.4275 19.9281 13.6308 19.9281 8.60361L19.9153 8.1111C20.6628 7.57798 21.3094 6.90816 21.8182 6.14561Z"
                      fill="white"></path>
                  </mask>
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="white"></path>
                  <mask id="mask0_620_709" maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="20">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M7.60063 2.18164H16.3991C19.3873 2.18164 21.8183 4.61264 21.8182 7.60057V16.3991C21.8182 19.387 19.3873 21.818 16.3991 21.818H7.60063C4.6127 21.818 2.18182 19.3871 2.18182 16.3991V7.60057C2.18182 4.61264 4.6127 2.18164 7.60063 2.18164ZM16.3993 20.0758C18.4266 20.0758 20.0761 18.4265 20.0761 16.3991H20.0759V7.60057C20.0759 5.5733 18.4265 3.92387 16.3991 3.92387H7.60063C5.57336 3.92387 3.92405 5.5733 3.92405 7.60057V16.3991C3.92405 18.4265 5.57336 20.0759 7.60063 20.0758H16.3993ZM6.85714 11.9999C6.85714 9.16406 9.16418 6.85697 12 6.85697C14.8358 6.85697 17.1429 9.16406 17.1429 11.9999C17.1429 14.8357 14.8358 17.1427 12 17.1427C9.16418 17.1427 6.85714 14.8357 6.85714 11.9999ZM8.62798 11.9998C8.62798 13.8591 10.1407 15.3717 12 15.3717C13.8593 15.3717 15.372 13.8591 15.372 11.9998C15.372 10.1404 13.8594 8.62772 12 8.62772C10.1406 8.62772 8.62798 10.1404 8.62798 11.9998Z"
                      fill="white"></path>
                  </mask>
          ...
          <div className=" ">
            <div className="flex items-center gap-[8px] "><svg width="19" height="19" viewBox="0 0 20 20"
              fill="none" xmlns="http://www.w3.org/2000/svg">
