        ...
        <>
            ...
            <section className="px-5 py-20 space-y-10">
                <div className="text-center space-y-5">
                    ...
                    <p className="">Stay ahead with cutting-edge strategies that drive business growth<br /> Enhance your brand presence with targeted promotions and digital engagement.</p>
                </div>
