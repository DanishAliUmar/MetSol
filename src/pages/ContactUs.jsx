        ...
        <>
            <div className="flex flex-col w-full bg-cover bg-center bg-no-repeat items-center justify-center relative">
                <img
                    ...
                    alt="Contact Us Page"
                />
                <div className=" absolute top-52 z-10 flex flex-col items-center justify-center">
                    <h1 className=" text-Black text-4xl font-bold  text-white">Contact Us</h1>
                    <h2 className=" text-Black font-normal mt-2 text-white">Home / Contact Us</h2>
                </div>
                <div className="flex flex-row justify-between items-center pt-16">
                    <div className="flex flex-col items-start justify-evenly w-full pl-14">
                        <h3 className='text-[#ffb700] text-xl font-semibold'>Contact Us</h3>
                        <h1 className='text-[#ffb700] text-4xl font-bold'>Reach Us For Instant Service</h1>
                    </div>
                    <div className="flex items-start md:gap-7 gap-3 md:pl-10 ">
                        <Svgs.Play className={'fill-[#ffb700] size-16 !h-10 rotate-90'} />
                ...
                <div className="flex flex-col justify-between items-start bg-[#ffb700] w-full p-10 rounded-lg">
